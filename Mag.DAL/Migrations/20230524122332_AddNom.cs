...
{
    /// <inheritdoc />
    public partial class AddNom : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.СоздатьTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_NomTypes", x => x.Id);
                })
                .Annotation("MySql:CharSet", "utf8mb4");
            ...
            migrationBuilder.СоздатьTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    NTypeId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Noms", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Noms_NomTypes_NTypeId",
                        column: x => x.NTypeId,
                        principalTable: "NomTypes",
                        principalColumn: "Id",
